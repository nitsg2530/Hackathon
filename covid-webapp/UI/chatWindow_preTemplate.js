function koreBotChat() {
    ...
    function chatWindow(cfg) {
        ...
        this.init();
		this.config.chatContainer.find('.minimized-title').html("Talk to " + this.config.chatTitle);
        updateOnlineStatus();
    ...
    chatWindow.prototype.bindEvents = function () {
        ...
        _chatContainer.off('click', 'li a').on('click', 'li a', function (e) {
		 ...
		 _chatContainer.off(
        		'click', '.buttonTmplContentBox li,.buttonTmplContentBox input,.listTmplContentChild .buyBtn,.viewMoreList .viewMore,.listItemPath,.quickReply,.carouselImageContent,.listRightContent,.buttonTmplContent .selectBtn').on(
        		'click', '.buttonTmplContentBox li,.buttonTmplContentBox input,.listTmplContentChild .buyBtn, .viewMoreList .viewMore,.listItemPath,.quickReply,.carouselImageContent,.listRightContent,.buttonTmplContent .selectBtn', 
        		function (e) {
                //e.preventDefault();
                ...
                if (type == "postback" || type == "text") {
    				...
    				//invert checked value of checkbox 
    				//debugger;			
    				var text = $(this).attr('actual-value') || $(this).attr('value');
    				var id = $(this).attr('cust-id');
    				var checkBoxEle = $('[name='+ id +'checkItem'+ timeStamp+']');
    				var checkedValue = checkBoxEle.is( ":checked" );
    			...
    			if( type === "selectbreakdownbtn" ) {    				
    				//fetch selected check items and then 
    				var selected = [];
    				$('.buttonTmplContentBox input:checked').each(function() {
    				    if( timeStamp === $(this).attr('time-stamp') ) {
    						selected.push($(this).attr('value'));
    					}
    				});
    				
    				//set chat input box value
    				$('.chatInputBox').text( selected.toString() );
    				
    				me.sendMessage($('.chatInputBox'), selected.toString());
    			}
			    			if( type === "showmorebtn" ) {
    				//fetch parent li
    				var parentUlEle = $(this).closest('ul');
    				
    				//toggle between show-more class
    				parentUlEle.find("li").toggleClass( "show-more" );
    				
    				var innerText = $(this).text().trim();
    				if( innerText.toLowerCase() === "show more" ) {
    					$(this).text("Show less");
    				}
    				else {
    					$(this).text("Show more");
        ...
        //NS - CI LuCi Chatbot - Implementing changes to minimize chatbot window in case of Close action
    ...
    chatWindow.prototype.sendMessage = function (chatInput,renderMsg) {
		...
		//NS - sending session cookie as well to bot so that even if it is updated, bot gets updated session id
        messageToBot["ciSessionCookie"] = document.cookie;
		...
		var regex = new RegExp("report for.*");
		var regexForSummaryFin = new RegExp("Summary Financials for.*");
		if(regex.test(msg)){
			var clientValues = msg.split(" ");						
			var requestParamObj = {
				  "requestDomain": "CitiInsight",
				  "responseDomain": "CitiInsight", 
				  "requestType": "open_tab",  
				  "url": "https://citiinsight.dev.citigroup.net:7080/CitiInsight/portal.html?rid=6499999999999991&rf1=2018~01~0~19~0&rf2="+clientValues[2]+"&rf5=gfcid&rf4="+clientValues[2]
			};

			var requestParamStr = JSON.stringify(requestParamObj);
			parent.parent.window.postMessage(requestParamStr, "*");
			//return;
			chatInput.html("");
			$('.sendButton').addClass('disabled');
			_bodyContainer.css('bottom', _footerContainer.outerHeight());
		...
		else if(regexForSummaryFin.test(msg)) {
			var msgValues = msg.split(" ");			
			var defaultGeo = 1000;
			if( msgValues[3] ) {
				defaultGeo = msgValues[3];
			}
			var requestParamObj = {
				"requestDomain": "CitiInsight",
				"responseDomain": "CitiInsight", 
				"requestType": "open_tab",  
				"url": "https://citiinsight.dev.citigroup.net:7080/CitiInsight/portal.html?rid=10099999999920&rf35=201606&rf2=1&rf17=1&rf18=1&rf14=0&rf12=1000&rf22=1&rf3=CGALL&rf2626=1&rf30=34~1000~Y~1~N~1000~Y~0~Y~ALL&rf31=20186&rf31=10964&rf31=11961&rf31=13190&rf31=13191&rf31=13401&rf31=11380&rf31=11823&rf31=11813&rf31=13583&rf31=11933&rf31=11811&rf31=11820&rf31=13383&rf31=11819&rf31=40031&rf31=20159&rf31=20158&rf31=40032&rf31=20187&rf31=20109&rf31=20005&rf31=40046&rf31=40051&rf31=40048&rf31=40044&rf31=40136&rf31=40027&rf31=20153&rf31=20435&rf32=1&rf33=1000105&rf34=76730BDE4747E881DFA6259982534E34&rf34=E852E7884C9D07A83C712EAC4ADD7B8E&rf34=51946AD9449B195C1E4A6EA46A455CDE&rf34=4586FEAF4D6ED873F627B1B8AFA01A45&rf34=F9C3BC524538364A8FBA11BDE8151486&rf34=D31DD8084846D90E31CBF2A25F6538B5&rf34=8E0720674548D2D7142FCA8FFC1508A0&rf34=D21969F448A5848DB6259EA585FCE77D&rf34=1D557A8E48A0842134A4298FA3183633&rf34=47800FCB4969B0BFCFACEA98C939D33D&rf34=055F316943B720C8071605B531B3CB60&rf34=ADD8F909443A3992750E83817EE25F6B&rf34=923E522945E5259A34EAEA9B8B332EA8&rf34=C588D1DF488A21502659A2B9A48F13E8&rf34=E4A3B2664FD6B42C2C88B98CC1340058&rf34=C5E1C19241A7E70B14DA00A465182D88&rf34=4841BE2540128C1AC419B6B6EE12116A&rf1=" + defaultGeo
			};
    ...
    chatWindow.prototype.renderMessage = function (msgData) {
		...
		if(messageHtml === '' && msgData && msgData.message && msgData.message[0]) {
			...
			else if (msgData.message[0] && msgData.message[0].component && msgData.message[0].component.payload && msgData.message[0].component.payload.template_type == "customCiCheckList") {
				 
				var clientTimestamp = new Date().getTime();
								
				messageHtml = $(me.getChatTemplate("templateCustomCiCheckList")).tmpl({
					'msgData': msgData,
			...
			//**ns22899 Citi Insight Changes Started**//
			else if (msgData.message[0] && msgData.message[0].component && msgData.message[0].component.payload && msgData.message[0].component.payload.template_type == "Singlebarchart") {
                messageHtml = $(me.getChatTemplate("SinglebarchartTemplate")).tmpl({
                    'msgData': msgData,
                    'helpers': helpers,
                    'extension': extension
                });
                setTimeout(function(){
                    ...
                    function drawChart() {
                        ...
                        var ele1 = [new Array('Industry','Metric value')];
						
						//validate whether CI columsn for chart are specified?
						if( msgData.message[0].component.payload.custCIColumns ) {							
							ele1 = [msgData.message[0].component.payload.custCIColumns];
						}
                        ...
                        for(var i=0;i<msgData.message[0].component.payload.elements.length;i++){
							...
							ele1[i+1] = new Array(currEle.title, parseInt(currEle.values), currEle.displayValues);
                        }
 
                       var elemens = ele1;
                       //console.log('data**************',elemens);
                        var data = google.visualization.arrayToDataTable(elemens);  
                        //**ns22899 Citi Insight Changes Started**//
					   ...
					   //**ns22899 Citi Insight Changes Ends**//
						var options = {
                            chartArea: {
                                height: "70%",
                                width: "80%",
                        ...
                        if(msgData.message[0].component.payload.direction === 'horizontal'){
                        	...
                        	console.log('in else condition of direction');
...
/*                    setTimeout(function(){
    ...
    chatWindow.prototype.getChatTemplate = function (tempType) {
        ...
        var chatWindowTemplate = '<script id="chat_window_tmpl" type="text/x-jqury-tmpl"> \
			<div class="kore-chat-window droppable minimize"> \
		...
		var customCiCheckListTemplate = '<script id="chat_message_tmpl" type="text/x-jqury-tmpl"> \
			{{if msgData.message}} \
				<li {{if msgData.type !== "bot_response"}}id="msg_${msgItem.clientMessageId}"{{/if}} class="{{if msgData.type === "bot_response"}}fromOtherUsers{{else}}fromCurrentUser{{/if}} with-icon"> \
					<div class="buttonTmplContent"> \
						{{if msgData.createdOn}}<div class="extra-info">${helpers.formatDate(msgData.createdOn)}</div>{{/if}} \
						{{if msgData.icon}}<div class="profile-photo"> <div class="user-account avtar" style="background-image:url(${msgData.icon})"></div> </div> {{/if}} \
						<ul class="buttonTmplContentBox customCiCheckListList" id="CI_LIST_${timeStamp}">\
							<li class="buttonTmplContentHeading"> \
								{{if msgData.type === "bot_response"}} {{html helpers.convertMDtoHTML(msgData.message[0].component.payload.text, "bot")}} {{else}} {{html helpers.convertMDtoHTML(msgData.message[0].component.payload.text, "user")}} {{/if}} \
								{{if msgData.message[0].cInfo && msgData.message[0].cInfo.emoji}} \
									<span class="emojione emojione-${msgData.message[0].cInfo.emoji[0].code}">${msgData.message[0].cInfo.emoji[0].title}</span> \
							...
							{{each(key, msgItem) msgData.message[0].component.payload.buttons}} \
								<li {{if timeStamp}}time-stamp="${timeStamp}"{{/if}} {{if msgItem.custCiId}}cust-id="${msgItem.custCiId}"{{/if}} {{if msgItem.payload}}value="${msgItem.payload}"{{/if}} {{if msgItem.payload}}actual-value="${msgItem.payload}"{{/if}} {{if msgItem.url}}url="${msgItem.url}"{{/if}} class="custCiClassForShowMore" data-value="${msgItem.value}" type="checkItem">\
								<input {{if timeStamp}}time-stamp="${timeStamp}"{{/if}} type="checkbox" {{if msgItem.custCiId}}cust-id="${msgItem.custCiId}"{{/if}} {{if msgItem.custCiId}}name="${msgItem.custCiId}checkItem${timeStamp}"{{/if}}{{if msgItem.payload}}value="${msgItem.payload}"{{/if}}>\
								${msgItem.title}\
								</li> \
							{{/each}} \
        					<li class="custCiClassForShowMore" >\
        						<span {{if timeStamp}}time-stamp="${timeStamp}"{{/if}} type="showmorebtn" class="selectBtn" >Show More</span>\
        					</li>\
        					<li class="custCiClassForShowMore custCiClassOkButton" >\
        						<span {{if timeStamp}}time-stamp="${timeStamp}"{{/if}} type="selectBreakdownBtn" class="selectBtn okBtnCiCheckList" title="Show breakdown for selected values">OK</span>\
    						</li>\
						</ul>\
					</div>\
				</li> \
		...
		//**ns22899 Citi Insight Changes Started**//		
		var SinglebarchartTemplate = '<script id="chat_message_tmpl" type="text/x-jqury-tmpl"> \
            {{if msgData.message}} \
                <li {{if msgData.type !== "bot_response"}}id="msg_${msgItem.clientMessageId}"{{/if}} class="{{if msgData.type === "bot_response"}}fromOtherUsers{{else}}fromCurrentUser{{/if}} with-icon barchart"> \
                    {{if msgData.createdOn}}<div class="extra-info">${helpers.formatDate(msgData.createdOn)}</div>{{/if}} \
                    {{if msgData.icon}}<div class="profile-photo extraBottom"> <div class="user-account avtar" style="background-image:url(${msgData.icon})"></div> </div> {{/if}} \
        ...
        } else if (tempType === "templateCustomCiCheckList") {
            return customCiCheckListTemplate;
		...
		//**ns22899 Citi Insight Changes Started**//
		else if(tempType === "SinglebarchartTemplate") {
            return SinglebarchartTemplate;
        }
		//**ns22899 Citi Insight Changes Ends**//
	...
	//NS added this code snippet to clear bot session in case user logs out of application
    //Here CI 
    this.clearUserSessionOnLogout = function() {
    ...
    function handleChartOnclick() {
        $('.piechartDiv,.barchartDiv, .linechartDiv').click(function(e){
            ...
            if(graphLibGlob === "d3") {
				...
				//**ns22899 Citi Insight Changes Started**//
				else if(data.type === "Singlebarchart") {
					google.charts.load('current', {packages: ['corechart', 'bar']});
					google.charts.setOnLoadCallback(drawChart);
					function drawChart() {
						container = document.getElementsByClassName('chartContainerDiv');
    ...
    ************************************************************************************************************************************************/
    ...
    return {
        ...
        clearUserSessionOnLogout: clearUserSessionOnLogout
    };
}